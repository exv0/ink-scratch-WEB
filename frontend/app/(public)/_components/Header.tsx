    ...
    <Link href={href} style={{ textDecoration: "none" }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <span style={{ fontSize: "12px", fontWeight: 600, fontFamily: "'Noto Sans JP', sans-serif", color: highlight ? "#FF6B35" : "rgba(255,255,255,0.75)" }}>
            {label}
          </span>
        </div>
        {badge && (
          <span style={{
            ...
            color: "#fff", padding: "2px 8px", borderRadius: "9999px",
...
function DDDivider({ label }: { label: string }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "8px", padding: "8px 4px 4px" }}>
      <div style={{ flex: 1, height: "1px", background: "rgba(255,255,255,0.06)" }} />
      <span style={{
        fontSize: "9px", fontWeight: 900, color: "rgba(255,255,255,0.2)",
...
export default function Header() {
  ...
  const navLinks = [
    ...
    ...(mounted && isAuthenticated
      ? [{ href: "/dashboard", label: "Dashboard" }, { href: "/manga", label: "Browse" }]
      : []),
  ];
  ...
  return (
    <>
      ...
      <header style={{
        ...
        <div style={{
          height: "2px",
          background: "linear-gradient(90deg, transparent 0%, #FF6B35 30%, #E63946 60%, transparent 100%)",
          opacity: 0.8,
        }} />
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                ...
                <Link href="/register" style={{ textDecoration: "none" }}>
                  <button style={{
                    ...
                    onMouseEnter={e => {
                      ...
                      (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 0 30px rgba(255,107,53,0.55)";
                    }}
                    onMouseLeave={e => {
                      (e.currentTarget as HTMLButtonElement).style.transform = "";
                      (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 0 18px rgba(255,107,53,0.35)";
                    }}
                  >
                    Sign Up Free
                    {/* Corner mark */}
              ...
              <div style={{ position: "relative" }} ref={dropdownRef}>
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "12px",
                    border: `1px solid ${dropdownOpen ? "rgba(255,107,53,0.25)" : "rgba(255,255,255,0.07)"}`,
                    background: dropdownOpen ? "rgba(255,107,53,0.05)" : "rgba(255,255,255,0.03)",
                ...
                >
                  ...
                  <div className="hidden sm:block" style={{ textAlign: "left" }}>
                    <p style={{
                      fontSize: "12px", fontWeight: 900, color: "rgba(255,255,255,0.85)",
                      fontFamily: "'Noto Sans JP', sans-serif",
                      lineHeight: 1, maxWidth: "100px",
                      overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
                    }}>
                      {user?.fullName || user?.username}
                    </p>
                    <p style={{
                      fontSize: "9px", color: "rgba(255,255,255,0.3)", marginTop: "2px",
                      fontFamily: "'Share Tech Mono', monospace", letterSpacing: "0.1em", textTransform: "capitalize",
                    }}>
                      {user?.role}
                    </p>
                  </div>
                  ...
                  {/* Chevron */}
                  <svg style={{
                    width: "12px", height: "12px", color: "rgba(255,255,255,0.3)",
                    flexShrink: 0,
                ...
                {dropdownOpen && (
                  <div className="dropdown-in" style={{
                    ...
                    borderRadius: "18px",
                    boxShadow: "0 20px 60px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,107,53,0.06)",
                    ...
                    <div style={{
                      ...
                      background: "linear-gradient(135deg, rgba(255,107,53,0.08) 0%, rgba(230,57,70,0.05) 100%)",
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "10px", position: "relative" }}>
                        ...
                        <span style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: "9px", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,107,53,0.6)" }}>
                          User Profile
                        </span>
                      </div>
                      {/* Avatar + info */}
                    ...
                    <div style={{ padding: "8px" }}>
                      <div style={{ padding: "4px 10px 2px" }}>
                        <span style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: "9px", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,255,255,0.2)" }}>
                          Account
                        </span>
                      </div>
            ...
            <button
              ...
              style={{
                ...
                border: "1px solid rgba(255,255,255,0.08)",
                background: mobileOpen ? "rgba(255,107,53,0.08)" : "rgba(255,255,255,0.03)",
                cursor: "pointer", transition: "all 0.2s",
                marginLeft: "4px",
              }}
              ...
              <div style={{ width: "18px", display: "flex", flexDirection: "column", gap: "4px" }}>
                {[0, 1, 2].map(i => (
                  <span key={i} style={{
                    ...
                    background: mobileOpen ? "#FF6B35" : "rgba(255,255,255,0.6)",
                    borderRadius: "9999px",
                    transition: "all 0.3s",
                    transformOrigin: "center",
                    transform: mobileOpen
                      ? i === 0 ? "rotate(45deg) translateY(5.5px)"
                      : i === 1 ? "scaleX(0)"
        ...
        {/* ── Mobile Menu ── */}
        {mounted && mobileOpen && (
          <div className="mobile-in md:hidden" style={{
                ...
                return (
                  <Link key={item.href} href={item.href} style={{ textDecoration: "none" }}>
                    <div style={{
                      ...
                      background: active ? "rgba(255,107,53,0.08)" : "transparent",
                      border: active ? "1px solid rgba(255,107,53,0.15)" : "1px solid transparent",
              ...
              <>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    overflow: "hidden", border: "1.5px solid rgba(255,107,53,0.25)", flexShrink: 0,
                  }}>
                    {user?.profilePicture ? (
                      <img src={user.profilePicture} alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                    ) : (
                  ...
                  <div style={{ minWidth: 0 }}>
                    <p style={{ fontSize: "13px", fontWeight: 900, color: "#fff", fontFamily: "'Noto Sans JP', sans-serif", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {user?.fullName || user?.username}
                    </p>
                    <p style={{ fontSize: "10px", color: "rgba(255,255,255,0.3)", fontFamily: "'Share Tech Mono', monospace", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {user?.email}
                    </p>
                  </div>
                </div>
              ...
              <div style={{ padding: "6px 12px 12px", display: "flex", gap: "8px" }}>
                ...
                <Link href="/register" style={{ flex: 1, textDecoration: "none" }}>
                  <button style={{
                    ...
                    boxShadow: "0 0 18px rgba(255,107,53,0.3)",
                  }}>
                    Sign Up Free
                  </button>
                </Link>
